...
let product_Data = [
  ...
  },
  {
    ...
    description:"Girl with a Pearl Earring by Johannes Vermeer (ca. 1665). From Wikimedia Commons, the free media repository.",
    category:'Vermeer',
    price: 600
  }
...
(function() {
  ...
  let makeCard = function(item) {
    ...
    image.onclick = function() {
      detail.innerHTML = ` ${item.description} <br> Price: <span class="text-success border border-white"> ${formatter.format(
        item.price
      )} </span>`;
    };
